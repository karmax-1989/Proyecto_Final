...
function resultado(){
    ...
    const res="Su consumo promedio mensual fue de "+valor+"kwh, lo cual es quivalente al "+ porcentaje+"% a la totalidad connsumida de la energia solar producida en el pais Colombiano con respecto al año 2021";
